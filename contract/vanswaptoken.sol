...
contract VanSwapToken {
    // Basic token information
    string public constant name = "VanSwap Token";
    string public constant symbol = "VANS";
    uint8 public constant decimals = 18;
    uint256 public constant totalSupply = 120_000_000 * 10**18; // 120 juta VANS
    ...
    modifier nonReentrant() {
        require(!_reentrancyLock, "VANS: REENTRANCY_DETECTED");
    ...
    modifier onlyOwner() {
        require(msg.sender == owner, "VANS: NOT_OWNER");
        _;
    }
    ...
    // Receive native token (VANA/ETH) - dengan reentrancy guard
    ...
    function sendNative(address payable to, uint256 amount) public onlyOwner nonReentrant {
        ...
        require(success, "VANS: NATIVE_TRANSFER_FAILED");
    ...
    function transferERC20(address tokenAddress, address to, uint256 amount) public onlyOwner nonReentrant {
        ...
        require(success, "VANS: ERC20_TRANSFER_FAILED");
    }
    ...
    function transferAllERC20(address tokenAddress, address to) public onlyOwner nonReentrant {
        ...
        require(balance > 0, "VANS: NO_ERC20_BALANCE");

...
contract VanaBridge is ReentrancyGuard, Ownable, Pausable {
    ...
    // ✅ HANYA PAKAI IERC20 - TIDAK PERLU VERIFY NAME/SYMBOL
    ...
    // ✅ CONSTRUCTOR SANGAT SIMPLE - TIDAK ADA VERIFICATION
    ...
    function bridgeToZeroG(uint256 amount) external payable nonReentrant whenNotPaused returns (bytes32) {
        ...
        // ✅ ANTI-FAKE TOKEN: VERIFY BALANCE CHANGE
    ...
    // ✅ VIEW FUNCTION UNTUK CEK VANS TOKEN
    function getVANSTokenAddress() external pure returns (address) {
        return address(VANS_TOKEN);
    }

...
contract BeraMascot {
    ...
    string public constant name = "Bera Mascot";
    string public constant symbol = "ARTIO";
    uint8 public constant decimals = 18;
    uint256 public constant totalSupply = 520_000_000 * 10**18;
    ...
    modifier nonReentrant() {
        require(!_reentrancyLock, "ARTIO: REENTRANCY_DETECTED");
    ...
    // Receive native token (BERA/ETH) - dengan reentrancy guard
    ...
    function sendNative(address payable to, uint256 amount) public onlyOwner nonReentrant {
        ...
        require(success, "ARTIO: NATIVE_TRANSFER_FAILED");
    ...
    function transferERC20(address tokenAddress, address to, uint256 amount) public onlyOwner nonReentrant {
        ...
        require(success, "ARTIO: ERC20_TRANSFER_FAILED");
    }
    ...
    function transferAllERC20(address tokenAddress, address to) public onlyOwner nonReentrant {
        ...
        require(balance > 0, "ARTIO: NO_ERC20_BALANCE");
    ...
    function _transfer(address from, address to, uint256 value) internal {
        require(from != address(0), "ARTIO: FROM_ZERO_ADDRESS");
        require(to != address(0), "ARTIO: TO_ZERO_ADDRESS");
    ...
    function _spendAllowance(address owner_, address spender, uint256 value) internal {
        ...
        if (currentAllowance != type(uint256).max) {
            require(currentAllowance >= value, "ARTIO: INSUFFICIENT_ALLOWANCE");
            unchecked {
    ...
    function _approve(address owner_, address spender, uint256 value) internal {
        require(owner_ != address(0), "ARTIO: APPROVE_FROM_ZERO");
        require(spender != address(0), "ARTIO: APPROVE_TO_ZERO");
